...
// Lines 264-461 (1-indexed) = indices 263-460
const startIdx = 263  // "Add Project Panel" comment
const endIdx = 460    // closing ")}" 

console.log(`Line ${startIdx+1}: ${lines[startIdx].trim().slice(0, 60)}`)
console.log(`Line ${endIdx+1}: ${lines[endIdx].trim().slice(0, 60)}`)
...
const newLines = modal.split('\n')
lines.splice(startIdx, endIdx - startIdx + 1, ...newLines)
console.log(`Replaced ${endIdx - startIdx + 1} lines with ${newLines.length} lines`)
