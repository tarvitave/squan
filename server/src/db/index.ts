...
export async function migrate() {
  ...
  const alterStatements = [
    ...
    // v0.4.0: skills + extensions
    `CREATE TABLE IF NOT EXISTS skills (id TEXT PRIMARY KEY, name TEXT NOT NULL, description TEXT, version TEXT, steps_json TEXT NOT NULL DEFAULT '[]', project_id TEXT, created_at TEXT NOT NULL DEFAULT (datetime('now')))`,
